package com.example.androidclientservice.webservice;
...
public class RestAPI {
	...
	private final String urlString ="http://192.168.88.194/JSONWebAPI/Handler1.ashx";
									//"http://testserver01.somee.com/Handler1.ashx";
									//"http://192.168.88.170/JSONWebAPI/Handler1.ashx";
									//"http://192.168.56.102/apitest2/Handler1.ashx";
									//"http://192.168.56.102/JSONWebApi/Handler1.ashx";
									//"http://tutecentral.somee.com/Handler1.ashx";
									//"ftp://testserver01.somee.com/www.testserver01.somee.com/Handler1.ashx";
									//"http://192.168.56.102/JSONWebAPI/Handler1.ashx"; // Genymotion AVD
    ...
    public JSONObject GetClientList() throws Exception {
        JSONObject result = null;
        JSONObject o = new JSONObject();
        JSONObject p = new JSONObject();
        o.put("interface","RestAPI");
        o.put("method", "GetClientList");
        o.put("parameters", p);
        String s = o.toString();
        String r = load(s);
        result = new JSONObject(r);
